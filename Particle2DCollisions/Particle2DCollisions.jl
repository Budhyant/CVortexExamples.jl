##############################################################################
#
# Particle2DCollisions.jl
#
# Models sets of particles colliding in 2D.
# Outputs to particles2D_STEP.vtu.
#
...
let
    ...
    println("Running Particle2DCollisions.jl")
    ...
    function save_particles(step)
        ...
        vtkfile = WriteVTK.vtk_grid("particles2D_"*string(step), 
            particle_pos', cells)
