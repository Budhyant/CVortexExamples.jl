...
# VortexRingSheet.jl
#
# Unsteady vortex lattice method with no vortex shedding. Outputs to terminal.
#
...
function induced_velocity(a::VortexRingSheet, mes_pts::Matrix{<:Real})
...
let
    ...
    influence = filament_induced_velocity_influence_matrix(fils, mes_pts, mes_dirs)
